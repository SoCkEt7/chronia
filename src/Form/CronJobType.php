...
class CronJobType extends AbstractType
{
    ...
    public function __construct(string $defaultCrontabUser)
    {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('user', TextType::class, [
                'label' => 'Crontab User',
                'help' => 'The user whose crontab will be modified (requires sudo rights)',
                'required' => false,
                'empty_data' => $this->defaultCrontabUser,
                'attr' => [
                    'placeholder' => $this->defaultCrontabUser,
                ],
            ])
